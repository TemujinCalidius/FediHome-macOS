...
public enum Micropub {
    public static func hEntry(content: String, title: String?, summary: String? = nil,
                              photoURLs: [String], draft: Bool) -> [String: Any] {
        ...
        if let summary = summary?.trimmingCharacters(in: .whitespacesAndNewlines), !summary.isEmpty {
            properties["summary"] = [summary] // → Post.excerpt (FediHome#181)
        }
